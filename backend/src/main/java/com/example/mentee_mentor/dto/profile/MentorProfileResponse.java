...
public class MentorProfileResponse {
    ...
    private Set<TopicSummary> expertise;
    ...
    public static MentorProfileResponse fromEntity(com.example.mentee_mentor.model.MentorProfile profile) {
        ...
        return MentorProfileResponse.builder()
                ...
                .expertise(profile.getExpertise() != null ? profile.getExpertise().stream()
